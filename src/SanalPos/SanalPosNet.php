...
use SanalPos\Exceptions\UnsupportedPaymentModelException;
use SanalPos\Exceptions\UnsupportedTransactionTypeException;
 ...
 * @package SanalPos
 */
class SanalPosNet implements SanalPosInterface
{
    use SanalPosHelpersTrait;
    ...
    /**
     * @var SanalPosNetCrypt|null
     */
    public $crypt;

    /**
     * SanalPosNet constructor.
     *
     * @param array $config
     * @param array $account
    ...
    public function __construct($config, $account, array $currencies)
    {
        ...
        $this->crypt = new SanalPosNetCrypt();
    ...
    public function getOosTransactionData()
    {
        ...
        $contents = $this->createXML([
            'posnetRequest' => [
                ...
                'tid'   => $this->account->terminal_id,
                'oosRequestData' => [
                    'posnetid'          => $this->account->SanalPosNet_id,
                    'ccno'              => $this->card->number,
    ...
    protected function check3DHash()
    {
        ...
        if ($this->crypt instanceof SanalPosNetCrypt) {
