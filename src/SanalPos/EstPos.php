...
class EstPos implements PosInterface
{
    ...
    * @return array
    */
    public function get3DForm(array $form_data)
    {
       echo '<form method="post" action="'.$form_data['gateway'].'"  name="3dForm" class="redirect-form" role="form">';
            foreach ($form_data['inputs'] as $key => $value){
                echo '<input type="hidden" name="'.$key.'" value="'.$value.'">';
            }
            echo '<div class="text-center">Yönlendiriliyorsunuz...</div>
            <hr>
