...
use Exception;
use Ankapix\SanalPos\Exceptions\BankClassNullException;
use Ankapix\SanalPos\Exceptions\BankNotFoundException;
...
class Pos
{
    ...
    public function __construct(array $account, array $config = null)
    {
        ...
        $this->config = $config ? $config : require __DIR__ . '/../config/sanalpos.php';
    ...
    * @return mixed
    */
    public function provision3D(){
        return $this->bank->provision3D();
    }
